...
namespace WorkshoManager.Migrations
{
    ...
    [Migration("20250609210222_AddCommentModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkshoManager.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkshoManager.Models.Part", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkshoManager.Models.ServiceTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkshoManager.Models.UsedPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkshoManager.Models.Comment", b =>
                {
                    ...
                    b.HasOne("WorkshoManager.Models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkshoManager.Models.UsedPart", b =>
                {
                    b.HasOne("WorkshoManager.Models.Part", "Part")
                        .WithMany()
                        .HasForeignKey("PartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WorkshoManager.Models.ServiceTask", "ServiceTask")
                        .WithMany()
                        .HasForeignKey("ServiceTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkshoManager.Models.ServiceTask", null)
                        .WithMany("UsedParts")
